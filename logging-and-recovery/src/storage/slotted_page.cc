...
/**
 * The bitwise representation of the slot is as follows:
 * 
 * | t(63~56) | s(55~48) | offset(47~32) | length(31~0) |
 * t: type of slot
 * s: state of slot
 * offset: offset of the tuple
 * length: length 
 */
...
/**
 * 1. Update data_start
 * 2. Check if there is enough space to add slot. If not, exit.
 * 3. Create slot value
 * 4. Add slot at end if first_free_slot == slot_count. If not, update existing slot
 * 5. Update free space. 
 * 
 */
