...
/**
 * 1. Go over all pages in heap segment, and check if there is a page with enough free space
 * 2. If not, create a new page and bump up page count for next allocation.
 */
