...
/**
 * BufferManager: 
 * 1. manage the buffer pool
 * 2. manage the pages
 * 3. manage the page replacement policy
 */
...
/**
 * Loads and pins a page in memory. Ensures safe access, prevents eviction. 
 *
 * 1. Check if page is in buffer. If yes, return the page
 * 2. If not, create a new page
 */
...
/**
 * Unpins the page after use, marks it dirty. Enables eviction and disk flushing.
 * 
 * 1. If page is dirty, mark it as dirty
 */
